...
(function($) {
	...
	function fnFormatResult(val, data, currentValue)
	{
	...
	Autocomplete.prototype = {
		...
		initialize: function() {
			...
			$(this.container).mousemove(function() { me.mouseMoved = true; });
		},
    ...
    fixPosition: function() {
      ...
      $('#' + this.mainContainerId).css({ 'margin-top': 0, 'left': 0 });
    ...
    onValueChange: function() {
      ...
      var field = '';
      if(this.el.hasClass('tinSearchInput')) {
              field = $('.tinSearchAdlibSearchfield').val();
              field = (field == '*') ? '' : field;
      }
    ...
    getSuggestions: function(q, field) {
      var cr, me;
      ...
      if (cr && $.isArray(cr.suggestions)) {
        ...
        if(me.options.params.field)
                delete me.options.params.field;
        if(field.length > 0)
